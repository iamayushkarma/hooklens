  ...
  return (
    ...
    >
      <motion.div
        ...
        className="rounded-2xl w-3/5 mx-auto bg-white shadow-[0_1px_2px_rgba(0,0,0,0.04),0_8px_24px_rgba(0,0,0,0.06)] p-4 transition-shadow duration-300"
        style={{
          boxShadow: isHovered
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <span className="text-[14px] font-semibold text-gray-900">Feb 6</span>
        ...
        <div className="grid grid-cols-3 gap-2 mt-4">
          ...
          <span className="text-[11px] text-gray-400">Tue</span>
          <span className="text-[11px] text-gray-400">Wed</span>
        </div>
        <div
          className="grid grid-cols-3 gap-1.5 mt-1.5"
          style={{ gridTemplateRows: "repeat(2, minmax(0, 1.5rem))" }}
        >
          <motion.div
            layout
            transition={shiftSpring}
