  ...
  return (
    <>
      <div
        ...
        className="border bg-bg-sidebar cursor-pointer border-border-default rounded-lg w-62 flex flex-col items-center justify-center hover:bg-base-hover h-56"
      >
