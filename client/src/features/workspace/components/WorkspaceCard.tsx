...
//       className="rounded-lg border border-border-default bg-bg-card transition-all hover:border-border-hover hover:shadow-sm cursor-pointer h-56 duration-200 hover:-translate-y-0.5"
//     >
//       {/* Header */}
...
//           <div
//             key={i}
//             className="w-5 h-5 rounded-full bg-bg-card border border-border-default -ml-1.5 first:ml-0 flex items-center justify-center"
//           >
//             <Users className="size-2.5 text-text-secondary" />
//           </div>
//         ))}
//         {count > 3 && (
...
//   if (stateFor === "Member") {
//     return (
//       <div className="flex flex-col gap-1.5 bg-bg-sidebar px-4 py-3 rounded-md w-full">
...
//             ))}
//             {count > 3 && (
//               <span className="bg-owner-bg text-accent text-[10px] font-medium w-5 h-5 rounded-full  border border-border-default -ml-1.5 first:ml-0 flex items-center justify-center">
//                 +{count - 3}
//               </span>
//             )}
//           </div>
...
//         <p className="text-md font-semibold text-text-primary">{count}</p>
//       </div>
//     </div>
//   );
// };
...
const pastelColors = [
  ...
  { bg: "#FEF3DC", text: "#8A5D00", darkBg: "#3A2B05", darkText: "#F5CC6A" },
  { bg: "#F0E8FB", text: "#6D3AAC", darkBg: "#2C1A42", darkText: "#D4A8F8" },
  { bg: "#E0F4F8", text: "#1A6678", darkBg: "#0E2D35", darkText: "#7FD4E8" },
  { bg: "#FDEEE5", text: "#AA4020", darkBg: "#3D1C0E", darkText: "#F7B898" },
  { bg: "#E2F6F0", text: "#1A6B55", darkBg: "#0E2E24", darkText: "#7FD4C0" },
];
